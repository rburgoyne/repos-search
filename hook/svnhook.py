...
parser.add_option("", "--sha1", dest="sha1", default="shasum",
  help="Command to digest stdin to SHA-1, defaults to 'shasum' in PATH.") # on osx link /sbin/md5 to /usr/sbin/md5sum
